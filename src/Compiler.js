...
export class Compiler {
  ...
  rune(runes, flags) {
    if (
      ((runes != null &&
        runes instanceof Array &&
        (runes.length == 0 || runes[0] == null || typeof runes[0] === 'number')) ||
        runes === null) &&
      (typeof flags === 'number' || flags === null)
    ) {
      return this.rune$int_A$int(runes, flags)
    } else if (
      (typeof runes === 'number' || runes === null) &&
      (typeof flags === 'number' || flags === null)
    ) {
  ...
  compile(re) {
    switch (re.op) {
      ...
      default:
        throw Object.defineProperty(new Error('regexp: unhandled case in compile'), '__classes', {
          configurable: true,
          value: [
            'java.lang.Throwable',
  ...
  class Frag {
    constructor(i, out, nullable) {
      if (
        ...
        (typeof nullable === 'boolean' || nullable === null)
      ) {
