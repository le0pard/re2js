...
export class MachineInput {
 ...
 if (MachineInput.EOF == null) {
    ...
    static fromUTF8(b, start, end) {
        if (((b != null && b instanceof Array && (b.length == 0 || b[0] == null || (typeof b[0] === 'number'))) || b === null) && ((typeof start === 'number') || start === null) && ((typeof end === 'number') || end === null)) {
            return MachineInput.fromUTF8$byte_A$int$int(b, start, end)
        } else if (((b != null && b instanceof Array && (b.length == 0 || b[0] == null || (typeof b[0] === 'number'))) || b === null) && start === undefined && end === undefined) {
    ...
    static fromUTF16(s, start, end) {
        if (((s != null && (s.constructor != null && s.constructor['__interfaces'] != null && s.constructor['__interfaces'].indexOf('java.lang.CharSequence') >= 0 || typeof s === 'string')) || s === null) && ((typeof start === 'number') || start === null) && ((typeof end === 'number') || end === null)) {
            return MachineInput.fromUTF16$java_lang_CharSequence$int$int(s, start, end)
        } else if (((s != null && (s.constructor != null && s.constructor['__interfaces'] != null && s.constructor['__interfaces'].indexOf('java.lang.CharSequence') >= 0 || typeof s === 'string')) || s === null) && start === undefined && end === undefined) {
...
(function(MachineInput) {
    class UTF8Input extends MachineInput {
        constructor(b, start, end) {
            if (((b != null && b instanceof Array && (b.length == 0 || b[0] == null || (typeof b[0] === 'number'))) || b === null) && ((typeof start === 'number') || start === null) && ((typeof end === 'number') || end === null)) {
                ...
                if (end > b.length) {
                    throw Object.defineProperty(new Error('end is greater than length: ' + end + ' > ' + b.length), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.IndexOutOfBoundsException', 'java.lang.Object', 'java.lang.ArrayIndexOutOfBoundsException', 'java.lang.RuntimeException', 'java.lang.Exception'] })
                }
                this.b = b
                this.start = start
                this.end = end
    ...
    class UTF16Input extends MachineInput {
        ...
        context(pos) {
            pos += this.start
            const r1 = pos > 0 && pos <= this.str.length ? CharacterHelper.codePointBefore(this.str, pos) : -1
        ...
        indexOfFallback(hayStack, needle, fromIndex) {
            ...
            for (let i = fromIndex; i <= max; i++) {
                {
                    if ((c => c.charCodeAt == null ? c : c.charCodeAt(0))(hayStack.charAt(i)) != (c => c.charCodeAt == null ? c : c.charCodeAt(0))(first)) {
                        while ((++i <= max && (c => c.charCodeAt == null ? c : c.charCodeAt(0))(hayStack.charAt(i)) != (c => c.charCodeAt == null ? c : c.charCodeAt(0))(first))) {
                            {
                            }
                        }
                    }
                    if (i <= max) {
                        ...
                        for (let k = 1; j < end && (c => c.charCodeAt == null ? c : c.charCodeAt(0))(hayStack.charAt(j)) == (c => c.charCodeAt == null ? c : c.charCodeAt(0))(needle.charAt(k)); j++, k++) {
                            {
                            }
                        }
                        if (j === end) {
