...
export class Pattern {
    constructor(pattern, flags, re2) {
        ...
        if (re2 == null) {
            throw Object.defineProperty(new Error('re2 is null'), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.NullPointerException', 'java.lang.Exception'] })
        }
    ...
    static compile$java_lang_String$int(regex, flags) {
        ...
        if ((flags & ~(Pattern.MULTILINE | Pattern.DOTALL | Pattern.CASE_INSENSITIVE | Pattern.DISABLE_UNICODE_GROUPS | Pattern.LONGEST_MATCH)) !== 0) {
            throw Object.defineProperty(new Error('Flags should only be a combination of MULTILINE, DOTALL, CASE_INSENSITIVE, DISABLE_UNICODE_GROUPS, LONGEST_MATCH'), '__classes', { configurable: true, value: ['java.lang.Throwable', 'java.lang.Object', 'java.lang.RuntimeException', 'java.lang.IllegalArgumentException', 'java.lang.Exception'] })
        }
    ...
    static compile(flregex, regex, flags) {
        if (((typeof flregex === 'string') || flregex === null) && ((typeof regex === 'string') || regex === null) && ((typeof flags === 'number') || flags === null)) {
            return Pattern.compile$java_lang_String$java_lang_String$int(flregex, regex, flags)
        } else if (((typeof flregex === 'string') || flregex === null) && ((typeof regex === 'number') || regex === null) && flags === undefined) {
            return Pattern.compile$java_lang_String$int(flregex, regex)
        } else if (((typeof flregex === 'string') || flregex === null) && regex === undefined && flags === undefined) {
    ...
    static matches(regex, input) {
        if (((typeof regex === 'string') || regex === null) && ((input != null && (input.constructor != null && input.constructor['__interfaces'] != null && input.constructor['__interfaces'].indexOf('java.lang.CharSequence') >= 0 || typeof input === 'string')) || input === null)) {
            return Pattern.matches$java_lang_String$java_lang_CharSequence(regex, input)
        } else if (((typeof regex === 'string') || regex === null) && ((input != null && input instanceof Array && (input.length == 0 || input[0] == null || (typeof input[0] === 'number'))) || input === null)) {
     ...
     */
    split(input, limit) {
        if (((typeof input === 'string') || input === null) && ((typeof limit === 'number') || limit === null)) {
            return this.split$java_lang_String$int(input, limit)
        } else if (((input != null && input instanceof Matcher) || input === null) && ((typeof limit === 'number') || limit === null)) {
