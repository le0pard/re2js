...
describe('.appendFoldedRange', () => {
  ...
  it.concurrent.each(cases)('lo %p, hi %p, returns %p', (lo, hi, expected) => {
...
describe('.appendClass', () => {
  ...
  it.concurrent.each(cases)('input %p, append %p, returns %p', (input, append, expected) => {
...
describe('.appendTable', () => {
  ...
  it.concurrent.each(cases)('input %p, table %p, returns %p', (input, table, expected) => {
...
describe('.appendGroup', () => {
  ...
  it.concurrent.each(cases)('input %p, group %p, returns %p', (input, group, expected) => {
