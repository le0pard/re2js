...
it.each(FIND_TESTS)('findUTF8 %s', (testPattern) => {
...
it.each(FIND_TESTS)('find %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findUTF8Index %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllUTF8 %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAll %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findUTF8Submatch %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findSubmatch %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findUTF8SubmatchIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findSubmatchIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllUTF8Submatch %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllSubmatch %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllUTF8SubmatchIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
...
it.each(FIND_TESTS)('findAllSubmatchIndex %s', (testPattern) => {
  const re = RE2.compile(testPattern.pat)
