 ...
 if (Regexp.EMPTY_SUBS == null) {
    ...
    appendTo(out) {
        switch ((this.op)) {
            case Regexp.Op.NO_MATCH:
                /* append */ (sb => { sb.str += '[^\\x00-\\x{10FFFF}]'; return sb })(out)
                break
            ...
            case Regexp.Op.REPEAT:
                {
                    ...
                    if (/* Enum.ordinal */Regexp.Op[Regexp.Op[sub.op]] > /* Enum.ordinal */ Regexp.Op[Regexp.Op[Regexp.Op.CAPTURE]] || (sub.op === Regexp.Op.LITERAL && sub.runes.length > 1)) {
                        /* append */ (sb => { sb.str += '(?:'; return sb })(out)
                        sub.appendTo(out);
                        /* append */ (sb => { sb.str += ')'; return sb })(out)
                    } else {
                    ...
                    switch ((this.op)) {
                        ...
                        case Regexp.Op.QUEST:
                            ...
                            break
                        case Regexp.Op.REPEAT:
                            /* append */ (sb => { sb.str += this.min; return sb })(/* append */ (sb => { sb.str += '{'; return sb })(out))
                            if (this.min !== this.max) {
                                /* append */ (sb => { sb.str += ','; return sb })(out)
                                if (this.max >= 0) {
                                    /* append */ (sb => { sb.str += this.max; return sb })(out)
                                }
                            }
                            /* append */ (sb => { sb.str += '}'; return sb })(out)
                            break
            ...
            case Regexp.Op.ALTERNATE:
                {
                    ...
                    for (let index = 0; index < this.subs.length; index++) {
                        let sub = this.subs[index]
                        {
                            /* append */ (sb => { sb.str += sep; return sb })(out)
                            sep = '|'
                            sub.appendTo(out)
                        }
                    }
            ...
            case Regexp.Op.LITERAL:
                if ((this.flags & RE2Flags.FOLD_CASE) !== 0) {
                    /* append */ (sb => { sb.str += '(?i:'; return sb })(out)
                }
            ...
            case Regexp.Op.ANY_CHAR_NOT_NL:
                /* append */ (sb => { sb.str += '(?-s:.)'; return sb })(out)
                break
            ...
            case Regexp.Op.CAPTURE:
                if (this.name == null || /* isEmpty */ (this.name.length === 0)) {
                    ...
                    /* append */ (sb => { sb.str += '(?P<'; return sb })(out);
                    /* append */ (sb => { sb.str += this.name; return sb })(out);
                    /* append */ (sb => { sb.str += '>'; return sb })(out)
                }
            ...
            case Regexp.Op.BEGIN_TEXT:
                /* append */ (sb => { sb.str += '\\A'; return sb })(out)
                break
            case Regexp.Op.END_TEXT:
                if ((this.flags & RE2Flags.WAS_DOLLAR) !== 0) {
                    /* append */ (sb => { sb.str += '(?-m:$)'; return sb })(out)
                } else {
                    /* append */ (sb => { sb.str += '\\z'; return sb })(out)
                }
                break
            ...
            case Regexp.Op.WORD_BOUNDARY:
                /* append */ (sb => { sb.str += '\\b'; return sb })(out)
                break
            ...
            case Regexp.Op.CHAR_CLASS:
                if (this.runes.length % 2 !== 0) {
                    /* append */ (sb => { sb.str += '[invalid char class]'; return sb })(out)
                    break
                }
                /* append */ (sb => { sb.str += '['; return sb })(out)
                ...
                break
            default:
                /* append */ (sb => { sb.str += this.op; return sb })(out)
                break
        }
    }
    maxCap() {
    ...
    hashCode() {
        ...
        switch ((this.op)) {
            ...
            case Regexp.Op.PLUS:
            case Regexp.Op.QUEST:
                hashcode += 31 * (this.flags & RE2Flags.NON_GREEDY) + 31 * /* hashCode */ ((o) => {
 if (o.hashCode) {
                    return o.hashCode()
                } else {
                ...
                break
            case Regexp.Op.REPEAT:
                hashcode += 31 * this.min + 31 * this.max + 31 * /* hashCode */ ((o) => {
 if (o.hashCode) {
                    return o.hashCode()
                } else {
                    return o.toString().split('').reduce((prevHash, currVal) => (((prevHash << 5) - prevHash) + currVal.charCodeAt(0)) | 0, 0)
                ...
                break
            case Regexp.Op.CAPTURE:
                hashcode += 31 * this.cap + 31 * (this.name != null ? /* hashCode */ ((o) => {
 if (o.hashCode) {
                    return o.hashCode()
                } else {
                    return o.toString().split('').reduce((prevHash, currVal) => (((prevHash << 5) - prevHash) + currVal.charCodeAt(0)) | 0, 0)
                }
})(this.name) : 0) + 31 * /* hashCode */ ((o) => {
 if (o.hashCode) {
                    return o.hashCode()
                } else {
                    return o.toString().split('').reduce((prevHash, currVal) => (((prevHash << 5) - prevHash) + currVal.charCodeAt(0)) | 0, 0)
    ...
    equals(that) {
        ...
        switch ((x.op)) {
            ...
            case Regexp.Op.CHAR_CLASS:
                if (!((a1, a2) => {
 if (a1 == null && a2 == null) {return true} if (a1 == null || a2 == null) {return false} if (a1.length != a2.length) {return false} for (let i = 0; i < a1.length; i++) {
            ...
            case Regexp.Op.PLUS:
            case Regexp.Op.QUEST:
                if ((x.flags & RE2Flags.NON_GREEDY) !== (y.flags & RE2Flags.NON_GREEDY) || !x.subs[0].equals(y.subs[0])) {
                    return false
                }
                break
            case Regexp.Op.REPEAT:
                if ((x.flags & RE2Flags.NON_GREEDY) !== (y.flags & RE2Flags.NON_GREEDY) || x.min !== y.min || x.max !== y.max || !x.subs[0].equals(y.subs[0])) {
                    return false
                }
                break
            case Regexp.Op.CAPTURE:
                if (x.cap !== y.cap || (x.name == null ? y.name != null : !(x.name === y.name)) || !x.subs[0].equals(y.subs[0])) {
                    return false
                }
                break
        }
...
(function(Regexp) {
    ...
    Op['_$wrappers'] = { 0: new Op_$WRAPPER(0, 'NO_MATCH'), 1: new Op_$WRAPPER(1, 'EMPTY_MATCH'), 2: new Op_$WRAPPER(2, 'LITERAL'), 3: new Op_$WRAPPER(3, 'CHAR_CLASS'), 4: new Op_$WRAPPER(4, 'ANY_CHAR_NOT_NL'), 5: new Op_$WRAPPER(5, 'ANY_CHAR'), 6: new Op_$WRAPPER(6, 'BEGIN_LINE'), 7: new Op_$WRAPPER(7, 'END_LINE'), 8: new Op_$WRAPPER(8, 'BEGIN_TEXT'), 9: new Op_$WRAPPER(9, 'END_TEXT'), 10: new Op_$WRAPPER(10, 'WORD_BOUNDARY'), 11: new Op_$WRAPPER(11, 'NO_WORD_BOUNDARY'), 12: new Op_$WRAPPER(12, 'CAPTURE'), 13: new Op_$WRAPPER(13, 'STAR'), 14: new Op_$WRAPPER(14, 'PLUS'), 15: new Op_$WRAPPER(15, 'QUEST'), 16: new Op_$WRAPPER(16, 'REPEAT'), 17: new Op_$WRAPPER(17, 'CONCAT'), 18: new Op_$WRAPPER(18, 'ALTERNATE'), 19: new Op_$WRAPPER(19, 'LEFT_PAREN'), 20: new Op_$WRAPPER(20, 'VERTICAL_BAR') }
})(Regexp || (Regexp = {}))
